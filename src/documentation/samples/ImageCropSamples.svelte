<script lang="ts">
	import { ImageCrop, CodeBlock, Switch } from '$lib/components';
					...
					<Container class="grid grid-cols-1 gap-8 md:grid-cols-2">
						...
						<Container class="flex flex-col gap-2">
							<Container class="flex items-center justify-between">
								...
								{#if resultImage}
									<Button
										onclick={async () => handleDownload(resultImage, 'crop-result.png')}
					...
					<Container class="grid grid-cols-1 gap-8 md:grid-cols-2">
						...
						<Container class="flex flex-col gap-2">
							<Container class="flex items-center justify-between">
								...
								{#if uploadResult}
									<Button
										onclick={async () => handleDownload(uploadResult, 'upload-crop-result.png')}
										class="fluid-button-primary scale-75"
									>
										Download
									</Button>
