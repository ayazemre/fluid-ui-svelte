...
<Container class="grid grid-cols-1 gap-8 md:grid-cols-2">
  ...
  <Container class="flex flex-col gap-2">
    ...
    <Container class="rounded-lg border p-6 dark:border-neutral-700">
      <InputField type="password" placeholder="Enter password" bind:value={passwordValue} class="w-full" />
  ...
  <Container class="flex flex-col gap-2">
    ...
    <Container class="rounded-lg border p-6 dark:border-neutral-700">
      <InputField type="textarea" placeholder="Enter your message..." bind:value={textAreaValue} class="h-32 w-full" />
  ...
  <Container class="flex flex-col gap-2">
    ...
    <Container class="rounded-lg border p-6 dark:border-neutral-700">
      <InputField class="fluid-input-field-error w-full" placeholder="Error styling" bind:value={errorValue} />
