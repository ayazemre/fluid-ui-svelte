...
<Container id="draggable-samples-container" class="flex flex-col gap-12">
  <Container id="draggable-sample-basic-section" class="flex flex-col gap-4">
    ...
    <Container id="draggable-sample-basic-preview" class="flex items-center gap-4 rounded-lg border bg-neutral-50 p-6 dark:border-neutral-700 dark:bg-neutral-900">
      <Draggable
