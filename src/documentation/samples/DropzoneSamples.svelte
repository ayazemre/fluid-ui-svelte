        ...
        {#snippet children({ isDragOver, isInvalid })}
          <Container class="flex flex-col items-center gap-2">
            ...
            {#if droppedFiles.length > 0 && !isDragOver}
              <Container class="mt-4 w-full rounded bg-neutral-100 p-2 text-left text-sm dark:bg-neutral-800">
          ...
          <Container class="flex flex-col items-center gap-2">
            ...
            {#if droppedData && !isDragOver}
              ...
              >
                ...
                <pre class="font-mono whitespace-pre-wrap text-neutral-600 dark:text-neutral-400">{droppedData}</pre>
              </Container>
            {/if}
          </Container>
        {/snippet}
